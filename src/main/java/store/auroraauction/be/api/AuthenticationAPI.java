...
public class AuthenticationAPI {
    ...
    public ResponseEntity Getstaff() {
        List<Account> account = autheticationService.getStaff();
    ...
    @PutMapping("UPROLE/update")
    public ResponseEntity updateUPROLEAccount(@RequestBody UPROLEREQUEST uprolerequest) {

        return ResponseEntity.ok(autheticationService.updateUPROLEAccount(uprolerequest));
    }
    @PutMapping("UPROLE1/update/{id}")
    public ResponseEntity updateUPROLE1Account(@RequestBody UPROLEREQUEST uprolerequest) {
